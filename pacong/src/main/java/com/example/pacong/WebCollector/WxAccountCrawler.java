package com.example.pacong.WebCollector;
...
public class WxAccountCrawler extends BreadthCrawler {
    ...
    private synchronized void writeHistoryKey(String key) throws IOException {
    ...
    private void addAccount(String account) throws UnsupportedEncodingException {
