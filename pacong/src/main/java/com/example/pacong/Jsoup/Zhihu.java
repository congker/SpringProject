...
/**
 * Created by xuwencong on 2019/4/17
 */
public class Zhihu {
    public static void main(String[] args) throws IOException {
        ...
        Elements url = main.select("div").select("div:nth-child(2)").select("h2").select("a[class=question_link]");
        for (Element question : url) {
            ...
            //<h1 class="QuestionHeader-title">如何看待爱否科技的王跃琨称华为 P30 Pro 拍的月亮是 PS 的?</h1>
//            Elements title = document2.getElementById("#root");

            Elements title = document2.getElementsByAttribute("QuestionHeader-title");
